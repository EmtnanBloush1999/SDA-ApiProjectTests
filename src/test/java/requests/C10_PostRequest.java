...
*/
    ...
    public void postRequestTest() {
        ...
        Response response = given(spec)
                //.contentType(ContentType.JSON)//For serialization we need to declare content type. This process is repetitive action, to avoid reputation we will put this in spec object.
                .body(expectedData)
                .post("{first}");
